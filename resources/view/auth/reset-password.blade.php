                                ...
                                <div class="card-content">
                                    <div class="card-body pt-1">
                                        <form action="<?=route('auth.reset.password',[$token])?>" method="post">
                                            ...
                                            <fieldset class="form-label-group">
                                                <input name="confirm_password" type="password" class="form-control <?=errorClass('confirm_password')?>"
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-12 col-md-6 mb-1">
                                                    <a href="<?=route('auth.login')?>" class="btn btn-outline-primary btn-block px-0">بازگشت به
                                                        پنل ورود</a>
                                                </div>
                                                <div class="col-12 col-md-6 mb-1">
                                                    <button type="submit" class="btn btn-primary btn-block px-0">ثبت
                                                        کلمه عبور جدید
                                                    </button>
                                                </div>
                                            </div>
