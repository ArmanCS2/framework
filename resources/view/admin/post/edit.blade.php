                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="row" action="<?=route('admin.post.update',[$post->id])?>" method="post"
                                        ...
                                        <fieldset class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select name="cat_id" class="select2 form-control <?=errorClass('cat_id')?>">
                                                    ...
                                                    <option value="<?=$category->id?>" <?=  oldOrValue('cat_id',$post->cat_id) == $category->id ? 'selected' : ''?>><?=$category->name?></option>
                                                    <?php } ?>
                                                </select>
                                                <?=errorText('cat_id')?>
                                            </div>
