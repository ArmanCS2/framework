                                    ...
                                    <table class="table zero-configuration">
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td style="min-width: 16rem; text-align: left;">
                                                ...
                                                <a href="<?= route('admin.post.change.status', [$post->id]) ?>"
                                                   class="btn btn-success waves-effect waves-light">فعال</a>
                                                <?php }else{ ?>
                                                <a href="<?= route('admin.post.change.status', [$post->id]) ?>"
                                                   class="btn btn-danger waves-effect waves-light">غیر فعال</a>
                                                <?php } ?>
