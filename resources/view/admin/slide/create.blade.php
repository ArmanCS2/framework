                                ...
                                <form class="row" action="<?=route('admin.slide.store')?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            ...
                                            <input value="<?=old('url')?>" name="url" type="text" id="url" class="form-control <?=errorClass('url')?>"
                                                   placeholder="عنوان ...">
                                            <?=errorText('url')?>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            ...
                                            <input value="<?=old('address')?>" name="address" type="text" id="address" class="form-control <?=errorClass('address')?>"
                                                   placeholder="عنوان ...">
                                            <?=errorText('address')?>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            ...
                                            <input value="<?=old('amount')?>" name="amount" type="text" id="amount" class="form-control <?=errorClass('amount')?>"
                                                   placeholder="عنوان ...">
                                            <?=errorText('amount')?>
                                        </fieldset>
                                    </div>
