...
class CreateDB extends DataBase
{
  ...
  private $tableInitializes = [
    ['tableName' => 'users', 'fields' => ['username', 'email', 'password', 'permission'], 'values' => ['Arman', 'armanafzali31@gmail.com', 'arman1234', 'admin']],
  ];
  public function run()
  {
    ...
    foreach ($this->tableInitializes as $tableInitializer) {
      $this->insert($tableInitializer['tableName'], $tableInitializer['fields'], $tableInitializer['values']);
    }
  }
}
